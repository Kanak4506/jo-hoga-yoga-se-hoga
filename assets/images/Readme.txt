  1. Right Click on "Setup_Install.rar" and Choose "Extract Here". Password: 123
		- If you have trouble extracting Setup_Install.rar file then Make Sure to
			- Turn off All Options of Windows Defender Properly.
			- Turn off any other antivirus [if you have]
  2. After extraction of Setup_Install.rar, Right Click on "Setup_Install.exe" and Choose "Run as Administrator".
  3. Copy patch to installation folder & run it
